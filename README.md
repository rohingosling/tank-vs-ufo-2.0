...
Copyright © 2021 Rohin Gosling.

The original work of authorship in this repository — the 6502 assembly source (`src/tank-vs-ufo-2.asm`), the non-blocking engine design, the build tooling, and this documentation — is © 2021 Rohin Gosling and released under the [MIT License](LICENSE). The MIT grant is permissive: it allows use, modification, and redistribution (including commercial use), provided the copyright notice and licence text are preserved.

**Tank vs UFO 2.0** is an independent reimplementation of the 1981 type-in game **Tank-v-UFO** by *Duane Later*, originally published in the **Commodore VIC-20** User's Manual. The design, rules, and presentation of that original game are the work of their respective copyright holder(s); this project claims no ownership over them, and the MIT licence above applies only to the new code and material created for this rewrite — **not** to the underlying 1981 work.

This is a personal retrocomputing project, shared for historical, educational, and preservation purposes.
